...
namespace ParticleEffects
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        {
            return howManyEffects * maxNumParticles - freeParticles.Count;
        }
        ...
        {            
            ...
            foreach (Particle p in particles)
            {
                ...
                Color color = p.TextureColor * getOpacityFactor(p);

                // make particles grow as they age. they'll start at 75% of their size,
                // and increase to 100% once they're finished.
                float scale = p.Scale * (.75f + .25f * getNormalizedLifetime(p));
        ...
        protected virtual float getOpacityFactor(Particle p)
        {
        ...
        protected virtual float getNormalizedLifetime(Particle p)
        {
