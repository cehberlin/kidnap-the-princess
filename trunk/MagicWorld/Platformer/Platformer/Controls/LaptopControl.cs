...
namespace MagicWorld.Controls
{
    class LaptopControl : IPlayerControl
    {
        ...
        {
            get { return Microsoft.Xna.Framework.Input.Keys.O; }
        }

        public Microsoft.Xna.Framework.Input.Keys Keys_CastSelectedSpellB
        {
            get { return Microsoft.Xna.Framework.Input.Keys.P; }
        }

        public Microsoft.Xna.Framework.Input.Keys Keys_SelectedSpellA
        {
            get { return Microsoft.Xna.Framework.Input.Keys.D9; }
        }

        public Microsoft.Xna.Framework.Input.Keys Keys_SelectedSpellB
        {
            get { return Microsoft.Xna.Framework.Input.Keys.D0; }
        }
