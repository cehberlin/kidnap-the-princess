...
namespace MagicWorld
{
    ...
    public class ShadowCreature : Enemy
    {
        ...
        public override Bounds Bounds
        {
            get
            {
                ...
                else
                {
                    ...
                    float height = (sprite.Animation.FrameHeight * 0.60f);
        ...
        /// <summary>
        /// greater bounds if creature is frozen
        /// </summary>
        protected override Bounds FrozenBounds
        {
            get
            {
            ...
            return new Bounds(left+30, top + 70, width-30, height - 90);
            }
        }
        ...
        public override Rectangle getDrawingArea()
        {
            ...
            return new Rectangle((int)left+30, (int)top + 70, (int)width-30, (int)height - 65);
        }
    }
}
