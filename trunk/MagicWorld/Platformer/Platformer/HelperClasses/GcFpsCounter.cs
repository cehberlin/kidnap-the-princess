...
namespace DikiLib
{
    public static class extensions
    {
        ...
        /// <summary>
        /// drawable gamecompone shows garbage collection count
        /// </summary>
        public class GARBAGE_COLLECTIONS_COUNTER : DrawableGameComponent
        {
            ...
            public GARBAGE_COLLECTIONS_COUNTER(Game _game)
                : base(_game)
            {
                DrawOrder = 0;
                text.Length = 0;
        ...
        /// <summary>
        /// drawable gamecomponet shows fps count
        /// </summary>
